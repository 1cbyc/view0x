...
process.env.DATABASE_URL = process.env.DATABASE_URL || 'postgresql://postgres:password@localhost:15433/view0x_test';
process.env.REDIS_URL = process.env.REDIS_URL || 'redis://localhost:16380';
